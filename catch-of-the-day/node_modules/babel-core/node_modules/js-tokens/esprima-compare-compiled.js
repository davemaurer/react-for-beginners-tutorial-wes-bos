...
function getJsTokensTokens(code) {
  return jsTokensTokenize(code).filter(function (token) {
    return !exclusionMap.hasOwnProperty(token.type);
  });
}
...
if (results.every(Boolean)) {
  console.log("Comparison succeeded: esprima and jsTokens produced the same tokens!");
} else {
  console.error("Comparison failed.");
}

//# sourceMappingURL=esprima-compare-compiled.js.map